...
gulp.task('buildOptionalVendorScripts', function() {
    ...
    var aScript56 = gulp.src(['../node_modules/datatables.net-bs5/js/dataTables.bootstrap5.js'])
        .pipe(gulp.dest('./assets/vendors/datatables.net-bs5'));
    var aScript57 = gulp.src(['../node_modules/datatables.net-bs5/js/dataTables.bootstrap5.js'])
        .pipe(gulp.dest('./assets/vendors/datatables.net-bs5'));
...
gulp.task('buildOptionalVendorStyles', function() {
    ...
    var map16 = gulp.src(['../node_modules/progressbar.js/dist/progressbar.min.js.map'])
        .pipe(gulp.dest('./assets/vendors/progressbar.js/'));
    var aStyle42 = gulp.src(['../node_modules/datatables.net-bs5/css/dataTables.bootstrap5.css'])
        .pipe(gulp.dest('./assets/vendors/datatables.net-bs5'));
